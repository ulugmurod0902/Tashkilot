...
<table class="table table-bordered">
    ...
    <tr>
        <th>T/R</th>
        <th>Tashkilot name</th>
        <th>Tashkilot address</th>
        <th>Tashkilot phone</th>
        <th>Amallar</th>
    </tr>
    </thead>
...
{{--               <a href="{{ route('companies.edit',['company' => $company->id]) }}" class="btn btn-danger"> <i class="bi bi-trash"></i> </a>--}}
            </td>
        </tr>
        @endforeach
    </tbody>
